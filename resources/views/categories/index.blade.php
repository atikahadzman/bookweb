    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-6 bg-gray-100">
            ...
            @endif
                ...
                <!-- Form Section -->
                <div>
                    <h1 class="text-3xl font-semibold text-gray-900 mb-6 border-b-2 border-gray-300 pb-2">Add New Category</h1>
                ...
                <!-- Table Section -->
                <div>
                    <h1 class="text-3xl font-semibold text-gray-900 mb-6 border-b-2 border-gray-300 pb-2">List of Categories</h1>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('categories.edit', $category->id) }}" title="Update">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="{{ route('categories.remove', $category->id) }}" title="Remove">
